...
namespace Contensive.Addon.aoFormWizard3.My {
    ...
    internal sealed class InternalXmlHelper {
        ...
        public static string get_Value(IEnumerable<System.Xml.Linq.XElement> source) {
            foreach (System.Xml.Linq.XElement item in source)
                return item.Value;
            return null;
        }

        public static void set_Value(IEnumerable<System.Xml.Linq.XElement> source, string value) {
            foreach (System.Xml.Linq.XElement item in source) {
                item.Value = value;
                break;
            }
        }
        public static string get_AttributeValue(IEnumerable<System.Xml.Linq.XElement> source, System.Xml.Linq.XName name) {
            foreach (System.Xml.Linq.XElement item in source)
                return (string)item.Attribute(name);
            return null;
        }

        public static void set_AttributeValue(IEnumerable<System.Xml.Linq.XElement> source, System.Xml.Linq.XName name, string value) {
            foreach (System.Xml.Linq.XElement item in source) {
        ...
        [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
        public static object RemoveNamespaceAttributes(string[] inScopePrefixes, System.Xml.Linq.XNamespace[] inScopeNs, List<System.Xml.Linq.XAttribute> attributes, object obj) {
            if (obj is not null) {
        ...
        [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
        public static IEnumerable RemoveNamespaceAttributes(string[] inScopePrefixes, System.Xml.Linq.XNamespace[] inScopeNs, List<System.Xml.Linq.XAttribute> attributes, IEnumerable obj) {
            if (obj is not null) {
                IEnumerable<System.Xml.Linq.XElement> elems = obj as IEnumerable<System.Xml.Linq.XElement>;
                if (elems is not null) {
        ...
        private sealed class RemoveNamespaceAttributesClosure {
            ...
            private readonly List<System.Xml.Linq.XAttribute> m_attributes;
            [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
            internal RemoveNamespaceAttributesClosure(string[] inScopePrefixes, System.Xml.Linq.XNamespace[] inScopeNs, List<System.Xml.Linq.XAttribute> attributes) {
        ...
        [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
        public static System.Xml.Linq.XElement RemoveNamespaceAttributes(string[] inScopePrefixes, System.Xml.Linq.XNamespace[] inScopeNs, List<System.Xml.Linq.XAttribute> attributes, System.Xml.Linq.XElement e) {
            if (e is not null) {
